component attributeName='pasport' {
	...
	function Render() {
		...
		// header
			...
			//		<h2>Форма авторизации</h2><br>Данная форма преднозначена для зарегистрированных пользователей.
			//		Если вы еще не зарегистрированы, то може перейти по этой ссылке <a href="">ссылка.</a>
			//	</div>
			//</div>';
