component attributeName='temp' {
	...
	function Init() {
		...
		instance.description='temp description';
		instance.keywords='temp keywords';
		...
		widget.menu=request.factoryWidget.GetWidget('menu').Init('temp');
		widget.info=request.factoryWidget.GetWidget('info').Init(pageName='temp',sniplet=instance.description);
		widget.temp=request.factoryWidget.GetWidget('temp').Init(instance.url.section,instance.url.action);
