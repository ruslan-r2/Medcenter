/*
	ƒобавить возможно отображени€ canonical при необходимости
*/
...
component attributeName='meta' {
	...
	<link rel="shortcut icon" href="#instance.shortcut#" type="image/x-icon">';
		...
		// проверка на включение у пользовател€ €ва или нет
		...
		// нужно передавать в €васкрипт CFID и CFTOKEN и все €ва запросы делать с этими параметрами без исключени€
